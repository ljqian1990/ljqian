...
$conf = array(  
    'listen'  => array('host' => '0.0.0.0','port' => '41000'),  
    'setting' => array(  
...
const REDIS_PWD = '';
const REDIS_S_KEY = 'redis_s_key';
const REDIS_S_FD = 'redis_s_fd';
const REDIS_FD_S = 'redis_fd_s';
const REDIS_ZS_KEY = 'redis_zs_key';
const PROCESS_NAME = 'process_name';

const REDIS_HOST_DATA = 'w2.dev.ztgame.com';
const REDIS_PORT_DATA = '6379';
const REDIS_PWD_DATA = '';
...
function handleClientData($ws, $frame) {  
    ...
    $redis->sAdd(REDIS_FD_S.$frame->fd, $ws);  
    $isMembers = $redis->sIsmember(REDIS_S_KEY, $ws);  
    if (!$isMembers) {   
        $redis->sAdd(REDIS_S_KEY, $ws);  
    }  
}  
