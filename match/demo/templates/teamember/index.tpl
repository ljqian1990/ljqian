...
<script type="text/javascript" src="?model=teamember&plugin=ydmatch&action=importScript&f=teamember.js"></script>
...
<div class="toolet-new">
	<form action="?model=teamember&plugin=ydmatch&action=import" method="post" enctype="multipart/form-data">
