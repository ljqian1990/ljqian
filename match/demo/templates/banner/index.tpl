...
<script type="text/javascript" src="?model=banner&plugin=ydmatch&action=importScript&f=library.js"></script>	
...
<div class="main">
	...
	<script type="text/javascript" src="?model=banner&plugin=ydmatch&action=importScript&f=index.inc.js"></script>	
