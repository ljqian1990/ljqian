...
class PlgYdmatchMvp implements IPlugin
{

    const MEMCACHE_MVP_LIST_KEY = 'balls_ydmatch_mvp_list_';
    const MEMCACHE_MVP_RANK_LIST_KEY = 'balls_ydmatch_mvp_rank_list';
    ...
    public function index()
    {
        ...
        $model = new CYdmatchmvp($this->site_id);
 ...
 <button type="button" class="ui-button close" icon="close" title="取消">取消</button>
    ...
    public function import()
    {
        ...
        header('Location: ?model=mvp&plugin=ydmatch&action=index');
    }
