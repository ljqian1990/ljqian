<?php
class PlgYdmatchNews implements IPlugin {
	const MEMCACHE_NEWS_COMP_LIST_KEY = 'balls_ydmatch_news_comp_list';
	const MEMCACHE_NEWS_NEWS_LIST_KEY = 'balls_ydmatch_news_news_list';
	const MEMCACHE_NEWS_INFO_KEY = 'balls_ydmatch_newsinfo_';
	...
	{			
		...
		$news = new CYdmatchnews($this->site_id);
	...
	public function active() {
		...
		$model = new CYdmatchnews ( $this->site_id );
