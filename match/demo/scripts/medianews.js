...
var Medianews = (function ($)
{
    ...
    this.init = function ()
    {
        ...
        $('table.ui-table span.ui-xicon').click(function ()
        {
            ...
            $.ajax({
            	url:'?model=medianews&plugin=ydmatch&action=active',
                data: {
                    'site_id': site_id,
                    'id': $(me).attr('bid')
                },
    ...
    this.xform = function (nid)
    {
        ...
        po_data.action = 'form';
        $.ajax({
        	url:'?plugin=ydmatch&model=medianews&action=form',
            data: po_data,
            dataType:"json",
            success: function (rp)
            {
    ...
    this.save = function (f)
    {
        ...
        $.ajax({
        	url:'?model=medianews&plugin=ydmatch&action=edit',
            data: $(f).serialize(),
            success: function (rp)
            {
                var txt = '';
    ...
    this.del = function (di)
    {
        ...
        $.ajax({
        	url:'?model=medianews&plugin=ydmatch&action=del',
            data: {
                'site_id': site_id,
                'del_id': data
            },
    ...
    {
        $.ajax({
        	url:'?model=medianews&plugin=ydmatch&action=make',
            data: {
                'site_id': site_id,
                'id': nid
            },
    ...
    {
        window.location.href = "/index.php?model=medianews&plugin=ydmatch&site_id=" + site_id + "&keyword=" + $(':input.srkey').val();
    };
    ...
    this.chg = function (oid, osort, nid, nsort)
    {
        ...
        $.ajax({
        	'url':'?model=medianews&plugin=ydmatch&action=zort',
            'data': {
                'site_id': site_id,
                'oid': oid,
                'osort': osort,
    ...
    this.makeAll = function ()
    {
        $.ajax({
        	type: "get",
        	url : "?model=medianews&plugin=ydmatch",
            'data': {
                'action': 'makeall',
                'site_id': site_id
            },
