...
var Livingswitch = (function ($)
{
    ...
    this.init = function ()
    {
        ...
        $('table.ui-table span.ui-xicon').click(function ()
        {
            ...
            $.ajax({
            	url:'?model=livingswitch&plugin=ydmatch&action=active',
                data: {
                    'site_id': site_id,
                    'id': $(me).attr('bid')
                },
    ...
    this.chg = function (oid, osort, nid, nsort)
    {
        ...
        $.ajax({
        	'url':'?model=livingswitch&plugin=ydmatch&action=zort',
            'data': {
                'site_id': site_id,
                'oid': oid,
                'osort': osort,
    ...
    this.xform = function (nid)
    {
        ...
        po_data.action = 'form';
        $.ajax({
        	url:'?plugin=ydmatch&model=livingswitch&action=form',
            data: po_data,
            dataType:"json",
            success: function (rp)
            {
    ...
    {       
        $.ajax({
        	url:'?model=livingswitch&plugin=ydmatch&action=edit',
            data: $(f).serialize(),
            success: function (rp)
            {
                var txt = '';
    ...
    this.del = function (di)
    {
        ...
        $.ajax({
        	url:'?model=livingswitch&plugin=ydmatch&action=del',
            data: {
                'site_id': site_id,
                'del_id': data
            },
    ...
    {
    	$.ajax({
    		url:"?model=livingswitch&plugin=ydmatch&action=editState",
