...
class PlgDemoTeamember implements IPlugin
{

    const MEMCACHE_TEAMEMBER_LIST_KEY = 'balls_demo_teamember_list';
    ...
    public function import()
    {
        ...
        header('Location: ?model=teamember&plugin=demo&action=index');
    }
