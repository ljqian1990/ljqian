...
<script type="text/javascript" src="?model=teamdata&plugin=demo&action=importScript&f=fenzu.js"></script>
<script type="text/javascript" src="?model=teamdata&plugin=demo&action=importScript&f=teamdata.js"></script>
...
<div class="toolet-new">
	<form action="?model=teamdata&plugin=demo&action=import" method="post" enctype="multipart/form-data">
