...
<script type="text/javascript" src="?model=mvp&plugin=demo&action=importScript&f=fenzu.js"></script>
<script type="text/javascript" src="?model=mvp&plugin=demo&action=importScript&f=mvp.js"></script>
...
<!--div class="toolet-new">
	<form action="?model=mvp&plugin=demo&action=import" method="post" enctype="multipart/form-data">
