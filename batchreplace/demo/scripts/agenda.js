...
var Agenda = (function ($)
{
    ...
    this.init = function ()
    {
        ...
        $('table.ui-table span.ui-xicon').click(function ()
        {
            ...
            $.ajax({
            	url:'?model=agenda&plugin=demo&action=active',
                data: {
                    'site_id': site_id,
                    'id': $(me).attr('bid')
                },
    ...
    this.xform = function (nid)
    {
        ...
        po_data.action = 'form';
        $.ajax({
        	url:'?plugin=demo&model=agenda&action=form',
            data: po_data,
            dataType:"json",
            success: function (rp)
            {
    ...
    this.save = function (f)
    {
        ...
        $.ajax({
        	url:'?model=agenda&plugin=demo&action=edit',
            data: $(f).serialize(),
            success: function (rp)
            {
                var txt = '';
    ...
    this.del = function (di)
    {
        ...
        $.ajax({
        	url:'?model=agenda&plugin=demo&action=del',
            data: {
                'site_id': site_id,
                'del_id': data
            },
    ...
    this.chg = function (oid, osort, nid, nsort)
    {
        ...
        $.ajax({
        	'url':'?model=agenda&plugin=demo&action=zort',
            'data': {
                'site_id': site_id,
                'oid': oid,
                'osort': osort,
    ...
    {
    	$.ajax({
        	url:'?plugin=demo&model=agenda&action=addGroupForm',
            data: {id:nid, gid:gid},
            dataType:"json",
            success: function (rp)
            {
    ...
    this.addGroup = function(f)
    {
        ...
        $.ajax({
        	url:'?model=agenda&plugin=demo&action=addGroup',
            data: $(f).serialize(),
            success: function (rp)
            {
                var txt = '';
